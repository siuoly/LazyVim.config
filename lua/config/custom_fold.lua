---copy from https://github.com/Wansmer/nvim-config/blob/main/lua/modules/foldtext.lua
---
---@module Foldtext
...
function Custom_fold_text()
  local ret = parse_line(vim.v.foldstart)
  if not ret or type(ret) == "string" then
    ret = { { vim.api.nvim_buf_get_lines(0, vim.v.lnum - 1, vim.v.lnum, false)[1], {} } }
  end
  local num_lines = " [" .. vim.v.foldend - vim.v.foldstart .. " lines] "
  table.insert(ret, { "  ", { } })
  table.insert(ret, { require("lazyvim.config").icons.misc.dots .. num_lines, { "Pmenusel" } })
  return ret
end

vim.opt.foldtext = 'luaeval("Custom_fold_text")()'
